...
/* OBSOLETE/UNUSED
/// Macro for defining local GRID_FACET_LIST for facets 
///   on upper/rightmost side of grid.<br>
/// Uses "for loop" to create local variable.
#define IJK_LOCAL_UPPER_GRID_FACET_LIST(_orth_dir,_grid,_DTYPE,_VTYPE,_facet_list,_counter0,counter1) \
   for (int _counter0=0, _counter1=0; _counter0<1; _counter0++)  \
     for (IJK::GRID_FACET_LIST<_DTYPE,_VTYPE,true> _facet_list(_grid,_orth_dir); _counter1<1; _counter1++)
*/
